...
$app
    ->get(
        ...
        {
            // Fetch promotion
            $prepare = $this->db->prepare('SELECT * FROM promotions WHERE year = :year LIMIT 1');
...
$app
    ->get(
        ...
        {
            // Fetch student
            $prepare = $this->db->prepare('SELECT * FROM students WHERE slug = :slug LIMIT 1');
...
//         function($request, $response)
//         {
//             return $this->view->render($response->withStatus(404), 'pages/error.twig');
//         }
//     )
//     ->setName('student')
// ;
